...
<section class="breadcrumb-area style2" style="background-image: url(frontend/images/slider/banner/about-us.png); background-size: cover;">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="about-style1-content">
                    ...
                    <div class="inner-content">
                        <div class="text">
                            <p>At HandyConnect, we understand the busy hectic lifestyles that many of us are having and we
                                ...
                                <p>Our team respects your schedule and arrives with all the tools and equipment necessary to
                                    ...
                                    <p>The most common interior repair works that we provide are: plumbing, electrical, locksmith,
                                        ...
                                        <p>HandyConnect offers a wide range of hassle-free handyman services. You will be happy to know
                                            that we are not only the handyman you need around your premises, we can help enhance the
                                            look and feel by offering interior design and renovation services by <a href="https://goodmaninterior.com/residential-home-renovation/" target="_blank">Goodman Interior</a> Goodman Interior</a> , our other
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="video-holder-box">
                    <div class="img-holder">
                        <img src="{{ asset('frontend/images/resources/video-gallery.jpg')}}" alt="Awesome Image">
                    </div>    
                </div>     
            </div>
        </div> 
