            ...
            <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
                <div class="form form-login">
                    <div class="shop-page-title">
                        <div class="title text-center">Register Now</div>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="col-xl-12">
                             ...
                             <div class="col-xl-12">
                                <div class="input-field">
                                    <input id="password_confirmation" type="text"  placeholder="Confirm Password" name="password_confirmation" required />
                                    <div class="icon-holder">
                                        <i class="fa fa-unlock-alt" aria-hidden="true"></i>
                                    </div>
                                </div>    
                            ...
                            <div class="col-xl-12">
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-sm-12">
                                        <button class="shop-btn btn-block" type="submit">Register Now</button>
