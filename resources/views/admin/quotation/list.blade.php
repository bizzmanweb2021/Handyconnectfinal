...
@section('content')
                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title titlefix">Quotation (Handy Connect)</h3>
                                    {{-- @can('customer.add')
    ...
    <div id="approve_modal" class="modal fade">
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title h6 text-capitalize">Accept Confirmation</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                </div>
                <div class="modal-body text-center">
                    <p class="mt-1">Are You Sure To Accept This?</p>
                    <button type="button" class="btn btn-link mt-2" data-dismiss="modal">@lang('role.cancel')</button>
                    <a href="" id="approve_link" class="btn btn-primary mt-2" data-leadid="">Accept</a>
                </div>
            </div>
        </div>
    </div>
