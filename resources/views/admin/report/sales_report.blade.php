    ...
    <body class="vertical-layout vertical-menu-modern 2-columns  navbar-sticky footer-static  " data-open="click"
        ...
        <div class="app-content content">
            ...
            <div class="content-wrapper">
                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title titlefix">@lang('Sales Report')</h3>
                                </div>
                                <div class="box-body">
                                    <div class="card">
                                        <div class="card-body">
                                            <form method="GET" action="{{route('admin.get_sales_report')}}">
                                                @csrf
                                                <div class="row">
                                                  <div class="col-5">
                                        ...
                                        <table id="sales_report" cellspacing="0" width="100%" class="text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$report['total_num_service']}}</td>
                                                    <td>{{$report['total_sales_amount']}}</td>
                                                    <td><button class="btn btn-secondary" data-toggle="modal" data-target=".bd-example-modal-lg" id="report_view" data-date="{{$report['date']}}"><i class="fa fa-info-circle" aria-hidden="true"></i></button></td>
                                                </tr>
                                                <?php $total += $report['total_sales_amount']; ?>
                                                @endforeach
                                            </tbody>
                                        </table>
                                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Sales Report Chart View for {{$date['start_date']}} to {{$date['end_date']}}</h5>
                        <div class="">
