                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title titlefix"> Handy Connect Inquries</h3>
                                    ...
                                    <div class="box-tools float-right">
                                     ...
                                     <div class="box-tools float-right">
                                    <a href="{{ URL::signedRoute('hc-quotation')}}" class="btn btn-primary btn-sm"><i class="fa fa-show"></i>
                                                View Quotation  </a>
                                </div>
