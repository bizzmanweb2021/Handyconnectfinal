                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active text-capitalize">Create Quotation
                                        </li>
                                    </ol>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title titlefix">Create Quotation</h3>
                                ...
                                <div class="box-body">
                                    ...
                                    <h4>Bill To HandyConnect Quotation</h4>
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    <label>company</label>
                                                    <div class="position-relative has-icon-left">
                                                       @foreach($data as $company) {{ $data->companies_name }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text" class="form-control" name="country"
                                                            placeholder="@lang('customer.country')" id="country" disabled
                                                            value="{{ $data->country }}">
                                                        <div class="form-control-position">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text" class="form-control" name="state"
                                                            placeholder="@lang('customer.country')" id="state" disabled
                                                            value="{{ $data->state }}">
                                                        <div class="form-control-position">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    <label>@lang('customer.zip_code')</label>
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text" class="form-control" name="country"
                                                            placeholder="@lang('customer.country')" id="zip_code" disabled
                                                            value="{{ $data->zip_code }}">
                                                        <div class="form-control-position">
                                                            <i class='bx bx-map'></i>
                                                        </div>
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="email" class="form-control" name="email"
                                                            placeholder="@lang('customer.email')" value="{{ $data->email }}"
                                                            id="email" disabled>
                                                        <div class="form-control-position">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="number" class="form-control" name="mobile"
                                                            placeholder="@lang('customer.mobile')"
...
@section('javascript')
    <script>
        ...
        $('#add_quotation_form_btn').click(function(e) {
            ...
            if ("{{ !empty(request()->customer_crm_id) }}") {
                data.append('customer_crm_id', "{{ request()->customer_crm_id }}");
            }
            $.ajax({
